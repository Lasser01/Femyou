...
namespace Femyou.Tests {
	public class PlatformTests {
		...
		public void GetLibraryPath(PlatformID platformID, bool is64bits, string baseFolder, string fmuName,
			string expectedLibraryPath) {
			Assert.That(Platform.GetLibraryPath(platformID, is64bits, baseFolder, fmuName),
